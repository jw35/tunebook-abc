...
.PHONY: website
website: $(targets) index.html index1.html errata.txt .htaccess abc abc2 midi midi2 mp3 mp3_2 dist/tunebook-abc.zip dist/tunebook2-abc.zip dist/tunebook-midi.zip dist/tunebook2-midi.zip dist/tunebook-mp3.zip dist/tunebook2-mp3.zip
	( \
		cd dist; \
		rsync -av --delete-delay  ../index.html ../index1.html ../errata.txt ../.htaccess $(target_filenames) abc abc2 midi midi2 mp3 mp3-2 tunebook-abc.zip tunebook2-abc.zip tunebook-midi.zip tunebook2-midi.zip tunebook-mp3.zip tunebook2-mp3.zip jonw@caracal.mythic-beasts.com:www/brsn.org.uk/tunebook-abc/; \
	)
